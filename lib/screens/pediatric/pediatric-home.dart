          ...
          onTap: () {
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => InputPage(
                    selected: 'Amoxicillin consentration(125mg/5ml)\n\nTarget Dose:15-30mg/kg/TID\n\nMax Dose:4g/daily',
                  ),
                ),
              );
            }
            if (index == 1) {
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => InputPage(
                    selected: 'Augmentin consentration(156mg/5ml)\n\nTarget Dose:0.25ml-0.5ml/kg/TID\n\nMax Dose:4g/day',
                  ),
                ),
              );
            }
            if (index == 2) {
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => InputPage(
                    selected: 'Azithromycin consentration(40mg/1ml)\n\nTarget Dose:10mg/kg/OD for 3days\n\nMax Dose:500mg/day',
                  ),
                ),
              );
            }
            ...
            if (index == 9) {
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => InputPage(
                    selected: 'Paracetamol syrup consentration(120mg/5ml)\nTarget Dose(2years-12years):10-15mg/kg\nMax Dose: 4doses in 24hours',
                  ),
                ),
              );
            }
            if (index == 10) {
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => InputPage(
                    selected: 'Paracetamol Drops consentration(100mg/1ml)\nTarget Dose(1day-1year):10-15mg/kg\nMax Dose: 4doses in 24hours',
                  ),
                ),
              );
            }
            ...
            if (index == 17) {
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => InputPage(
                    selected: 'Ferrous Sulphate Drops consentration(125mg/1ml)\nTarget Dose(1month-12month):0.5-1.2ml/OD',
                  ),
                ),
              );
            }
          ...
          Expanded(
            child: GridView.count(
              ...
              children: [
                ...
                makeDashboardItem("Cefuroxime", "assets/images/p.png", 3),
                makeDashboardItem("Cloxacillin", "assets/images/p.png", 4),
                makeDashboardItem("Cephalexin", "assets/images/p.png", 5),
                makeDashboardItem("Metronidazole", "assets/images/p.png", 6),
                makeDashboardItem("Erythromycin", "assets/images/p.png", 7),
                makeDashboardItem(
                    "Phenoxy\n methyl\npenicillin", "assets/images/p.png", 8),
                makeDashboardItem(
                    "Paracetamol syrup", "assets/images/p.png", 9),
                makeDashboardItem(
                    "Paracetamol Drops", "assets/images/p.png", 10),
                makeDashboardItem("Ibuprofen", "assets/images/p.png", 11),
